...
local SaveManager = {} do
	...
	function SaveManager:BuildConfigSection(tab,disablecloudconfigs)
		...
		if not disablecloudconfigs then
			...
			local BrowserLIB = loadstring(game:HttpGet("https://raw.githubusercontent.com/ErethonRunsU/EvolutionSkid/main/browserlib.lua"))()
			local Configs = game:GetService("HttpService"):JSONDecode(httprequest({Url = 'https://raw.githubusercontent.com/ErethonRunsU/EvolutionSkid/main/configs.json'}).Body)['Configs']
